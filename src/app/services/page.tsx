...
const FILTERS: { key: ServiceCategory | "all"; label: string }[] = [
  ...
  { key: "government", label: "Government & Compliance" },
  ...
  return (
    <>
      <PageHero
        ...
        description="Government compliance and digital growth, handled by specialists. Tap any service to see eligibility, documents, pricing, and process."
      />

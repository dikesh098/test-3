...
export const metadata: Metadata = {
  ...
  description: "eSakha's refund policy and terms of service for development, marketing, and SaaS/AI services.",
};
...
const SECTIONS: TermsSection[] = [
  {
    ...
    icon: "📋",
    content:
      "Due to the nature of digital, consulting, marketing, and software/AI services, all payments made to eSakha are generally non-refundable once work has been initiated. By purchasing or confirming any service, the client acknowledges and agrees to this policy.",
  },
  {
    num: "2",
    title: "AI Agents, Automation & CRM Platform",
    icon: "🤖",
    content:
      "For AI agent builds, automation projects, and the CRM SaaS platform:",
    bullets: [
      "Discovery, scoping, and configuration work is billable once started, and is non-refundable.",
      "CRM subscription fees are billed per cycle and are non-refundable for the current billing period once it has begun; you may cancel future renewals at any time.",
      "Clients are responsible for providing accurate data and information for integrations and imports.",
    ],
  },
  {
    num: "3",
  ...
  },
  {
    ...
    bullets: [
      ...
      "Search rankings, sales revenue, or specific AI model outputs/behaviour",

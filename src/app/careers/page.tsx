            ...
            {JOB_OPENINGS.map((job, i) => (
              <Reveal key={job.id} delay={0.06 * i}>
                <div className="glass glass-hover flex h-full flex-col rounded-2xl p-7 shadow-[var(--shadow-card)]">
                  ...
                  <h3 className="font-display mt-2 text-lg font-bold text-ink">{job.title}</h3>
                  ...
                  <button
                    ...
                    className="mt-4 rounded-xl edge-gradient py-2.5 text-sm font-semibold text-[#04150f] transition hover:-translate-y-0.5 hover:opacity-90"
                  >
                    Apply for this role
                  </button>
                </div>

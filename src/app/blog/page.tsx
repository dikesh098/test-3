...
export const metadata: Metadata = {
  title: "Blog",
  description: "Practical guides on web development, digital marketing, AI agents, and CRM adoption for growing businesses.",
};
  ...
  return (
    <>
      <PageHero
        ...
        description="Straight answers on web development, digital marketing, and AI adoption — no jargon."
      />
        ...
        <div className="mx-auto max-w-4xl space-y-5">
          {BLOG_POSTS.map((post, i) => (
            <Reveal key={post.slug} delay={0.06 * i}>
              <Link
                href={`/blog/${post.slug}`}
                className="glass glass-hover group block rounded-2xl p-7 shadow-[var(--shadow-card)] transition hover:-translate-y-1 hover:shadow-[var(--shadow-card-lg)]"
              >
                ...
                <h2 className="font-display mt-3 text-xl font-bold text-ink group-hover:text-brand">
                  {post.title}
                </h2>

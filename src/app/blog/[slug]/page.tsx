  ...
  return (
    <article className="px-5 py-16 sm:px-8">
      <div className="mx-auto max-w-2xl">
        ...
        <h1 className="font-display mt-3 text-[clamp(1.8rem,4vw,2.6rem)] font-extrabold leading-tight text-ink">
          {post.title}
        </h1>
        ...
        <div className="mt-12 glass rounded-2xl p-6 text-center">
          <p className="text-sm font-medium text-ink">Need help with this? Talk to our team directly.</p>
          <Link
            href="/contact"
            className="mt-3 inline-flex items-center gap-2 rounded-full edge-gradient px-6 py-2.5 text-sm font-semibold text-[#04150f] transition hover:-translate-y-0.5 hover:opacity-90"
          >
            Contact eSakha
          </Link>
        </div>

...
const SECTIONS = [
  ...
  },
  {
    ...
    body: [
      "We use the information you provide to respond to your enquiry, process your service application, process payments, evaluate job/internship applications, and contact you about the status of your request via phone, WhatsApp, or email.",
      ...
      <section className="px-5 py-16 sm:px-8">
        <div className="mx-auto max-w-3xl space-y-10">
          ...
          <div className="rounded-2xl border border-line-2 bg-brand-light p-6">
            <h2 className="font-display text-lg font-bold text-ink">10. Contact Us</h2>

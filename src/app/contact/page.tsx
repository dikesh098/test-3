      ...
      <section className="px-5 py-16 sm:px-8">
        <div className="mx-auto grid max-w-6xl gap-12 lg:grid-cols-[1fr_1.1fr]">
          ...
          <Reveal direction="right">
            <div className="glass rounded-2xl p-7 shadow-[var(--shadow-card)] sm:p-9">
              <h3 className="font-display mb-5 text-xl font-bold text-ink">Send Us a Message</h3>
              <ContactPageForm />
            </div>
          </Reveal>
        </div>
...
function InfoCard({
  ...
  const content = (
    <div className="glass flex items-start gap-3.5 rounded-xl p-5 shadow-[var(--shadow-card)]">

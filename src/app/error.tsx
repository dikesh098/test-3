...
export default function ErrorBoundary({
  ...
  return (
    <section className="flex min-h-[60vh] flex-col items-center justify-center px-5 py-24 text-center sm:px-8">
      ...
      <h1 className="font-display mt-4 text-2xl font-bold text-ink">Something Went Wrong</h1>
      ...
      <div className="mt-7 flex flex-wrap justify-center gap-3">
        <button
          onClick={reset}
          className="flex items-center gap-2 rounded-full edge-gradient px-6 py-3 text-sm font-semibold text-[#04150f] transition hover:-translate-y-0.5 hover:opacity-90"
        >

...
function PayModal({
  ...
  return (
    ...
    >
      <div className="relative w-full max-w-md overflow-hidden rounded-3xl border border-line bg-surface-2 shadow-2xl">
        <div className="relative bg-gradient-to-br from-brand-dark to-brand-mid px-8 pb-6 pt-8">
          <button
            onClick={onClose}
        ...
        {success ? (
          <div className="px-8 py-10 text-center">
            ...
            <h3 className="font-display text-lg font-extrabold text-ink">Payment Successful!</h3>
            ...
            <button
              onClick={onClose}
              className="mt-6 rounded-xl edge-gradient px-8 py-3 text-sm font-semibold text-[#04150f] transition hover:opacity-90"
            >
              Done
            </button>
          </div>

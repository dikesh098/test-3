        ...
        <div className="mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {TESTIMONIALS.map((t, i) => (
            <Reveal key={t.name} delay={0.07 * i}>
              <div className="glass glass-hover rounded-2xl p-7 transition hover:-translate-y-1 hover:shadow-[var(--shadow-card-lg)]">
                ...
                <div className="flex items-center gap-3">
                  <div className="font-display flex h-11 w-11 shrink-0 items-center justify-center rounded-full edge-gradient text-base font-extrabold text-[#04150f]">
                    {t.initial}
                  </div>
                  <div>

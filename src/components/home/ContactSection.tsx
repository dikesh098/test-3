      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mt-12 grid gap-12 lg:grid-cols-[1fr_1.1fr]">
          <Reveal direction="left">
            <div>
              <h3 className="font-display mb-5 text-xl font-bold text-ink">Visit Us / Call Us</h3>
              ...
              <div className="my-5 rounded-xl border-l-4 border-brand bg-brand-light px-5 py-4">
                ...
                <p className="mt-1.5 text-sm font-medium text-ink">Sunday: {CONTACT.hours[1].time}</p>
              </div>
              ...
              <div className="flex flex-col gap-2.5">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-center gap-2 rounded-xl glass glass-hover border-2 border-brand py-3.5 text-sm font-semibold text-brand transition hover:-translate-y-0.5"
                >

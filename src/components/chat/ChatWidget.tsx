...
const GREETING: ChatMessage = {
  role: "assistant",
  content:
    "Hi! I'm the eSakha Assistant. Ask me about web & app development, digital marketing, AI agents, or the CRM platform — or let me know what you need help with and I'll point you in the right direction.",
};
  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-[100px] right-7 z-[150] flex h-[58px] w-[58px] items-center justify-center rounded-full edge-gradient text-[#04150f] shadow-[0_4px_24px_rgba(34,197,139,0.35)] transition hover:scale-110"
      >
        {open ? <X size={24} /> : <Bot size={26} />}
      </button>

      {open && (
        <div className="fixed bottom-[168px] right-5 z-[160] flex h-[min(70vh,520px)] w-[min(92vw,380px)] flex-col overflow-hidden rounded-2xl border border-line bg-surface-2 shadow-2xl">
          <div className="flex items-center gap-3 bg-gradient-to-br from-brand-dark to-brand-mid px-5 py-4">
          ...
          <div ref={scrollRef} className="flex-1 space-y-3 overflow-y-auto bg-surface-2 px-4 py-4">
            ...
            {loading && (
              <div className="flex justify-start">
                <div className="flex items-center gap-2 rounded-2xl border border-line bg-surface-3 px-4 py-2.5 text-ink-3">
          ...
          <div className="border-t border-line bg-surface-2 p-3">
            <div className="flex items-end gap-2">
              <textarea
                ...
                placeholder="Ask about a service, pricing, or what's included..."
                rows={1}
              ...
              <button
                ...
                className="flex h-[42px] w-[42px] shrink-0 items-center justify-center rounded-xl edge-gradient text-[#04150f] transition hover:opacity-90 disabled:opacity-50"
              >
                <Send size={17} />
              </button>
            </div>
